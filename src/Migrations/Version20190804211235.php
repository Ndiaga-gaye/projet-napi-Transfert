 ...
 */
final class Version20190804211235 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depot CHANGE numero_compte numero_compte INT NOT NULL');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE depot CHANGE numero_compte numero_compte INT DEFAULT NULL');
